      ...
      <div id={loc} className={`bg-[#FFFFFF]`}>
        <div className='py-20 flex flex-col justify-center items-center mx-10'>
          ...
          <div className='text-center'>
            ...
            <div className='pt-4 text-[#2D2E32] text-center text-[30px] font-bold font-sans leading-tight flex items-center justify-center flex-wrap sm:flex-nowrap'>Software Developer based in Bhopal, India📍</div>
